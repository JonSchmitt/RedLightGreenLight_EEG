...
class EntityStateFactory:
    ...
    def create_idle_state():
        if not EntityStateFactory._idle_state:
            from RedLightGreenLight.States.Game.Entites.EntityStates.IdleEntityState import IdleEntityState
    ...
    def create_walking_state():
        if not EntityStateFactory._walking_state:
            from RedLightGreenLight.States.Game.Entites.EntityStates.WalkingEntityState import WalkingEntityState
    ...
    def create_dead_state():
        if not EntityStateFactory._dead_state:
            from RedLightGreenLight.States.Game.Entites.EntityStates.DeadEntityState import DeadEntityState
